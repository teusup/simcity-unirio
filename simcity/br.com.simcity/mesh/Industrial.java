...
public class Industrial extends Privado {
	private int empregos;
	private int maxEmpregos;
	public Industrial(int custoConstrucao, int manutencaoSemanal, int energia_necessaria, int agua_necessaria, int empregos, int maxEmpregos, int imposto) {		
